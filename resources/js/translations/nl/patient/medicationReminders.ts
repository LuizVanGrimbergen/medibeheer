export default {
    settingsTitle: 'Medicatie-herinneringen',
    settingsLinkDescription:
        'Meldingen aan- of uitzetten wanneer u medicatie moet innemen.',
    settingsDescription:
        'U krijgt een melding op het moment dat u medicatie moet innemen. Tik op de melding om inname te registreren.',
    settingsEnabledStatus: 'Herinneringen staan aan.',
    settingsDisabledStatus: 'Herinneringen staan uit.',
    disableButton: 'Herinneringen uitzetten',
    promptTitle: 'Herinnering voor uw medicatie',
    promptDescription:
        'U krijgt een melding op het moment dat u medicatie moet innemen. Tik op de melding zelf om inname te registreren.',
    installRequiredNote:
    ...
    missingConfig:
        'Herinneringen zijn op dit moment niet beschikbaar. Vraag hulp aan uw familie of beheerder als dit blijft.',
    enableButton: 'Herinneringen aanzetten',
