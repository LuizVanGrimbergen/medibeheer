...
import type { PatientPushMarkSuccessScreenProps } from '@/lib/patient/medications/screen/patientPushMarkSuccessScreenProps';

const props = defineProps<PatientPushMarkSuccessScreenProps>();
